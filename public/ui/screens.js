...
.site-header {
  ...
  z-index: 10;
  background: #053E1D;
  border-bottom: 1px solid rgba(0,255,79,0.15);
  box-shadow: 0 4px 20px rgba(5,62,29,0.2);
}
.header-inner {
  max-width: 1100px;
  margin: 0 auto;
...
.nav-features summary {
  ...
  padding: 8px 14px;
  border-radius: 999px;
  border: 1px solid rgba(249,240,225,0.25);
  color: rgba(249,240,225,0.85);
}
...
.nav-feature-panel {
  ...
  gap: 6px;
  min-width: 240px;
  box-shadow: 0 12px 36px rgba(5,62,29,0.12);
}
.nav-feature-panel a {
  padding: 6px 8px;
  border-radius: 8px;
...
.plan-card {
  ...
  border-radius: 24px;
  padding: 28px;
  box-shadow: 0 8px 24px rgba(5,62,29,0.08);
}
.plan-today-card h2 {
  margin: 8px 0 4px;
  font-family: 'Montserrat', sans-serif;
...
.plan-upcoming-list li {
  ...
  gap: 10px;
  padding: 12px 16px;
  border: 1px dashed rgba(5,62,29,0.2);
  border-radius: 14px;
  color: var(--muted);
}
.plan-grid {
...
.workout-card {
  ...
  padding: 18px;
  background: #FFFFFF;
  box-shadow: 0 4px 16px rgba(5,62,29,0.06);
  position: relative;
  overflow: hidden;
...
.workout-card.locked::after {
  ...
  position: absolute;
  inset: 0;
  background: rgba(249,240,225,0.55);
  border-radius: 18px;
  pointer-events: none;
}
.workout-card.active {
...
.exercise-row {
  ...
  gap: 12px;
  padding: 10px 0;
  border-bottom: 1px solid rgba(5,62,29,0.08);
}
...
.profile-summary-card {
  ...
  padding: 32px;
  border: none;
  box-shadow: 0 12px 40px rgba(5,62,29,0.2);
}
.profile-pill {
  padding: 8px 16px;
  border-radius: 999px;
  background: rgba(0,255,79,0.15);
  color: #00FF4F;
  font-family: 'Montserrat', sans-serif;
  font-weight: 700;
...
.profile-meta-item {
  ...
  padding: 16px 18px;
  border: 1px solid rgba(5,62,29,0.1);
  box-shadow: 0 4px 12px rgba(5,62,29,0.06);
  color: #1D1D1D;
}
.profile-program-card {
  ...
  padding: 34px 32px;
  color: #F9F0E1;
  box-shadow: 0 16px 48px rgba(5,62,29,0.2);
  display: flex;
  flex-direction: column;
  gap: 22px;
}
.program-progress {
  ...
  height: 10px;
  border-radius: 999px;
  background: rgba(249,240,225,0.25);
  overflow: hidden;
}
...
.program-start-btn {
  ...
  box-shadow: 0 8px 24px rgba(0,255,79,0.3);
}
.program-start-btn:hover {
  transform: translateY(-2px);
  box-shadow: 0 12px 32px rgba(0,255,79,0.4);
}
